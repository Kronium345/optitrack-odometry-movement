...
axs[0].plot(optitrack_df['pos_x'], optitrack_df['pos_y'], label='Optitrack', linestyle='-', marker='x', markersize=5)
axs[0].scatter([optitrack_df['pos_x'].iloc[0]], [optitrack_df['pos_y'].iloc[0]], color='green', marker='x', s=100, label='Start Point')
axs[0].scatter([optitrack_df['pos_x'].iloc[-1]], [optitrack_df['pos_y'].iloc[-1]], color='red', marker='x', s=100, label='End Point')
...
axs[0].plot(optitrack_sync['pos_x'], optitrack_sync['pos_y'], label='Optitrack', linestyle='-', marker='x', markersize=5)
...
axs[1].set_title('Odometry - FLU Transformation')
axs[1].set_xlabel('pos_x Coordinate')
axs[1].set_ylabel('pos_y Coordinate')
axs[1].legend()
...
ax.plot(optitrack_sync['pos_x'], optitrack_sync['pos_y'], optitrack_sync['pos_z'], label='Optitrack', linestyle='-', marker='x', markersize=5)
